...
namespace ExpenseSplitter.Api.Infrastructure.Migrations
{
    ...
    [Migration("20250809103629_CursorPaging")]
    partial class CursorPaging
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExpenseSplitter.Api.Domain.Settlements.Settlement", b =>
                {
                    ...
                    b.HasIndex("UpdatedOnUtc", "Id")
                        .IsDescending()
                        .HasDatabaseName("IX_settlements_updatedatutc_id_desc");
            ...
            modelBuilder.Entity("ExpenseSplitter.Api.Domain.SettlementUsers.SettlementUser", b =>
                {
                    b.HasOne("ExpenseSplitter.Api.Domain.Participants.Participant", "Participant")
                        .WithMany("SettlementUsers")
                        .HasForeignKey("ParticipantId")
